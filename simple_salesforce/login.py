...
def SalesforceLogin(
    ...
    * client_id -- the ID of this client
    ...
    soap_url = 'https://{hostname}/services/Soap/u/{sf_version}'
    if not hostname:
        hostname = 'test.salesforce.com' if sandbox else 'login.salesforce.com'
    ...
    soap_url = soap_url.format(hostname=hostname, sf_version=sf_version)
